...
git add -A && git commit -m "Student/Teacher, redirect depending of the role. But there is a security problem"
...
git add -A && git commit -m "Student/Teacher/Admin "
